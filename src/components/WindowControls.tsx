          ...
          {onSave !== undefined && (
            ...
            >
              <button
                ...
                className={`w-8 h-8 flex items-center justify-center rounded-xl transition-colors duration-150 cursor-pointer disabled:cursor-default ${
                  isSaved
          ...
          {onNewConversation !== undefined && (
            <Tooltip label="New conversation">
              <button
                ...
                data-history-toggle
                className="w-8 h-8 flex items-center justify-center rounded-xl text-text-secondary hover:text-text-primary hover:bg-white/5 transition-colors duration-150 cursor-pointer"
              >
