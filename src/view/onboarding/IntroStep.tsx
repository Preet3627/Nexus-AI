...
export function IntroStep({ onComplete }: Props) {
  ...
  const handleGetStarted = async () => {
    // Sync the local preference to settings before finishing
    await updateSettings({ launch_at_login: launchAtLogin });
        ...
        >
          <div
            style={{
              ...
              height: 18,
              borderRadius: 5,
              border: `1px solid ${launchAtLogin ? "#ff8d5c" : "rgba(255,255,255,0.15)"}`,
              background: launchAtLogin ? "#ff8d5c" : "transparent",
              display: "flex",
              alignItems: "center",
              justifyContent: "center",
          ...
          <span style={{ fontSize: 13, color: "rgba(255,255,255,0.65)" }}>
            Launch Nexus AI automatically at login
          </span>
        </div>
